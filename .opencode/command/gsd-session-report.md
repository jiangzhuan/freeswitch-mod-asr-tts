...
<execution_context>
@C:/dev/workspace/opencode_wk/freeswich_mod/.opencode/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/dev/workspace/opencode_wk/freeswich_mod/.opencode/get-shit-done/workflows/session-report.md end-to-end.
</process>

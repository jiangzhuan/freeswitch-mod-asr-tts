...
Reference full template: `C:/dev/workspace/opencode_wk/freeswich_mod/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/workspace/opencode_wk/freeswich_mod/.opencode/get-shit-done/templates/state.md`.
